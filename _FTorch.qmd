...
Vgc![]( https://raw.githubusercontent.com/pytorch/pytorch/main/docs/source/_static/img/pytorch-logo-dark.png ){style="background-image: radial-gradient(gray 0%, #03334E 100%);" .absolute top=55% left=5% width=20%}

![](https://raw.githubusercontent.com/pytorch/pytorch/main/docs/source/_static/img/pytorch-logo-dark.png){style="background-image: radial-gradient(gray 0%, #03334E 100%);" .absolute top=55% left=5% width=40%}
...
:::
::: {.fragment}
- **Forpy**, **SmartSim**, **Fortran-Keras Bridge**
  - Various issues
...
![]( https://raw.githubusercontent.com/pytorch/pytorch/main/docs/source/_static/img/pytorch-logo-dark.png ){style="background-image: radial-gradient(gray 0%, #03334E 75%);" .absolute bottom=12.5% right=22% height=10%}
...
## Model - Saving model from Python {.smaller}

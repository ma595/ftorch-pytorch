## FTorch in Action {.smaller auto-animate=true}

:::: {.columns style="gap: 2em;"}

::: {.column width="50%"}
::: {.fragment .semi-fade-out}
### 🌍 MiMA – Proof of Concept {style="font-size: 1.1em;"}

- First use of FTorch ideas  
- Machine-learning parameterisation in a simple climate model  
- Showed feasibility but exposed **speed** and **integration** limits  
- Led to creation of FTorch for reusable, efficient coupling

[{{< fa brands github >}}/DataWaveProject/MiMA-machine-learning](https://github.com/DataWaveProject/MiMA-machine-learning)
:::
:::

::: {.column width="50%"}
::: {.fragment}
### ☁️ CESM – Large-Scale Integration {style="font-size: 1.1em;"}

- FTorch now part of **Community Earth System Model (CESM)**  
- Integrated via **CIME** build system  
- **libtorch** available on NCAR’s *Derecho* supercomputer  
- Enables reproducible ML parameterisations at climate scale  

![](https://www.hpcwire.com/wp-content/uploads/2022/03/derecho-ncar-render.png){style="margin-top: 0.5em; border-radius: 8px;" width="95%"}
:::
:::
::::
